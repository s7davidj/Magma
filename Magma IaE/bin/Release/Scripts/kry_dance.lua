...
local D = false
-------------
local m = Instance.new("Model",game.Workspace.CloneCharacter) m.Name = "ModelParts"
local miniweld = nil
local rootpart = nil
...
----------musics---------------
	...
	M2=SetMusic(1247091361) --changed to our house
	M3=SetMusic(168570436) 
	M4=SetMusic(142435409) 
	M5=SetMusic(152350859) --longer they spin me right round
