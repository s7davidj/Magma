...
local Humanoid = game.Workspace.CloneCharacter:FindFirstChildOfClass("Humanoid")
...
for i,v in pairs(mas:GetChildren()) do
	v.Parent = game.Workspace.CloneCharacter
...
char = game.Workspace.CloneCharacter
hum = game.Workspace.CloneCharacter:FindFirstChildOfClass("Humanoid")
...
Player=owner
Character=game.Workspace.CloneCharacter
PlayerGui=Player.PlayerGui 
Backpack=Player.Backpack 
Torso=Character.Torso 
Head=Character.Head 
Humanoid=game.Workspace.CloneCharacter.Humanoid
