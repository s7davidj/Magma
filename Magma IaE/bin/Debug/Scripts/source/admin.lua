...
CMDs[#CMDs + 1] = {NAME = 'vr', DESC = 'For use with a virtual reality headset and 6 hats (WILL BE PATCHED SOON)'}
...
CMDs[#CMDs + 1] = {NAME = 'walkto [plr]', DESC = 'Follow a player'}
CMDs[#CMDs + 1] = {NAME = 'unwalkto', DESC = 'Stops following a player'}
...
CMDs[#CMDs + 1] = {NAME = 'nobgui / nobillboardgui', DESC = 'Removes billboard and surface guis from your players (i.e. name guis at cafes)'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
...
CMDs[#CMDs + 1] = {NAME = 'clickteleport', DESC = 'Go to settings>Keybinds>Add for clicktp'}
...
CMDs[#CMDs + 1] = {NAME = 'nohats / deletehats', DESC = 'Deletes your hats'}
...
CMDs[#CMDs + 1] = {NAME = 'equiphats / hattool', DESC = 'Allows you to hold your hats like a tool'}
CMDs[#CMDs + 1] = {NAME = 'equiptools', DESC = 'Equips every tool in your inventory at once'}
CMDs[#CMDs + 1] = {NAME = 'reach on [num]', DESC = 'Increases the hitbox of your held tool'}
CMDs[#CMDs + 1] = {NAME = 'reach off', DESC = 'turns off reach'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
...
addcmd('swim',{},
	...
	gravReset = Players.LocalPlayer.Character:FindFirstChildOfClass('Humanoid').Died:connect(swimDied)
	...
	Players.LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.Flying,false)
	Players.LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.Freefall,false)
	Players.LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.GettingUp,false)
	Players.LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.Jumping,false)
	Players.LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.Landed,false)
	Players.LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.Physics,false)
	Players.LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.PlatformStanding,false)
	Players.LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.Ragdoll,false)
	Players.LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.Running,false)
	Players.LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.RunningNoPhysics,false)
	Players.LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.Seated,false)
	Players.LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.StrafingNoPhysics,false)
	Players.LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.Swimming,false)
	Players.LocalPlayer.Character.Humanoid:ChangeState(Enum.HumanoidStateType.Swimming)
end)
...
addcmd('unswim',{'noswim'},
	...
	Players.LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.Flying,true)
	Players.LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.Freefall,true)
	Players.LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.GettingUp,true)
	Players.LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.Jumping,true)
	Players.LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.Landed,true)
	Players.LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.Physics,true)
	Players.LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.PlatformStanding,true)
	Players.LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.Ragdoll,true)
	Players.LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.Running,true)
	Players.LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.RunningNoPhysics,true)
	Players.LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.Seated,true)
	Players.LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.StrafingNoPhysics,true)
	Players.LocalPlayer.Character.Humanoid:SetStateEnabled(Enum.HumanoidStateType.Swimming,true)
	Players.LocalPlayer.Character.Humanoid:ChangeState(Enum.HumanoidStateType.RunningNoPhysics)
end)
...
addcmd('chardelete',{'charremove','cd'},
    ...
    dels(Players.LocalPlayer.Character)
notify('Item(s) Deleted','Deleted ' ..getstring(1))
end)
...
addcmd('nobgui',{'unbgui','nobillboardgui','unbillboardgui'},
	function(args, speaker)
...
addcmd('blockhead',{},
	function(args, speaker)
	Players.LocalPlayer.Character.Head:FindFirstChildOfClass("SpecialMesh"):Destroy()
end)

addcmd('blockhats',{},
	function(args, speaker)
	for _,v in pairs(Players.LocalPlayer.Character.Humanoid:GetAccessories()) do
...
addcmd('creeper',{},
	...
	if r15(Players.LocalPlayer) then
		Players.LocalPlayer.Character.Head:FindFirstChildOfClass("SpecialMesh"):Destroy()
		Players.LocalPlayer.Character.LeftUpperArm:Destroy()
		Players.LocalPlayer.Character.RightUpperArm:Destroy()
		for _,v in pairs(Players.LocalPlayer.Character.Humanoid:GetAccessories()) do
			v:Destroy()
		end
	else
		Players.LocalPlayer.Character.Head:FindFirstChildOfClass("SpecialMesh"):Destroy()
		Players.LocalPlayer.Character["Left Arm"]:Destroy()
		Players.LocalPlayer.Character["Right Arm"]:Destroy()
		for _,v in pairs(Players.LocalPlayer.Character.Humanoid:GetAccessories()) do
			v:Destroy()
		end
	end
...
addcmd('hattool',{'equiphats','hattools'},
	function(args, speaker)
	for _,v in pairs(Players.LocalPlayer.Character.Humanoid:GetAccessories()) do
		if v.Handle then
...
function FEGodmode()
	...
	if workspace.CurrentCamera.CameraSubject == Players.LocalPlayer.Character.Humanoid or workspace.CurrentCamera.CameraSubject == Players.LocalPlayer.Character then
		changeview = true
	end
...
addcmd('bring',{'febring'},
	...
	if tools(Players.LocalPlayer) then
		if args[1] then
			refresh(Players.LocalPlayer)
			wait()
			repeat wait() until Players.LocalPlayer.Character ~= nil and Players.LocalPlayer.Character:FindFirstChild('HumanoidRootPart')
			wait(0.3)
			local changeview = false
			if workspace.CurrentCamera.CameraSubject == Players.LocalPlayer.Character.Humanoid or workspace.CurrentCamera.CameraSubject == Players.LocalPlayer.Character then
				changeview = true
			...
			for i,v in pairs(players)do
				if v ~= Players.LocalPlayer then
					local target = Players[v]
					local NOW = Players.LocalPlayer.Character.HumanoidRootPart.CFrame
					...
					tp(target, Players.LocalPlayer)
					wait(0.2)
					tp(target, Players.LocalPlayer)
					wait(0.5)
					Players.LocalPlayer.Character.HumanoidRootPart.CFrame = NOW
					wait(0.5)
					getout(Players.LocalPlayer, target)
					wait(0.3)
					Players.LocalPlayer.Character.HumanoidRootPart.CFrame = NOW
					wait(0.3)
					refresh(Players.LocalPlayer)
...
addcmd('vr',{},
	function(args, speaker)
	loadstring(game:HttpGet(('https://pastebin.com/raw/shBZc5tT'),true))()
	notify('Controls','[R2] Sprint, [L2] Crouch, [Y] Reset, [B] Laser Beam, [X] Toggle Chat HUD (Left hand)')
end)
...
if pcall(function() loadstring(game:HttpGet(('https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/version'),true))() end) then
	if ver ~= Version then
