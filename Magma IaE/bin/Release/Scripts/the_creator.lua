...
--[[ Name : Airthes The Creator! (Thou who collects the souls of innocents) ]]--
...
for i,v in pairs(game.Workspace.CloneCharacter:GetChildren()) do
			if v:IsA('Accessory') then
				v:destroy()
			end
end
game.Workspace.CloneCharacter.Head.face.Texture = "rbxasset://" 
--no face face


local players = game.Players.LocalPlayer

if game.Players.LocalPlayer:FindFirstChild("TAG") then
				game.Workspace.CloneCharacter.Head.Transparency = 0
game.Players.LocalPlayer:FindFirstChild("TAG"):Destroy()
...
Music.Volume = 5
Music.SoundId = "rbxassetid://367193208"
Music.Looped = true
...
function dead()
error("player is dead, making script not work")
end
game.Workspace.CloneCharacter:FindFirstChildOfClass("Humanoid").Died:Connect(dead)
end
